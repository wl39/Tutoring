...
//                //boundary,
//            case 'P':
//                if ((board[originalRow + 1][originalColumn] == '.') || (original_boundary(originalRow + 1, originalColumn))) {
//                    return true;
//                } else if ((board[originalRow + 1][originalColumn + 1] != '.') || (original_boundary(originalRow + 1, originalColumn + 1))) {
//                    return true;
//                } else if ((board[originalRow + 1][originalColumn - 1] != '.') || (original_boundary(originalRow + 1, originalColumn - 1))) {
//                    return true;
//                } else {
//                    System.out.println("The pawn can not move");
//                    return false;
//                }
//            case 'K':
//                if ((board[originalRow + 1][originalColumn] == '.') || (blackcharecterchoosen(originalColumn, originalRow + 1))) {
//                    return true;
//                } else if ((board[originalRow - 1][originalColumn] == '.') || (blackcharecterchoosen(originalColumn, originalRow - 1))) {
//                    return true;
//                } else if ((board[originalRow - 1][originalColumn - 1] == '.') || blackcharecterchoosen(originalColumn - 1, originalRow - 1)) {
//                    return true;
//                } else if ((board[originalRow - 1][originalColumn + 1] == '.') || (blackcharecterchoosen(originalColumn + 1, originalRow - 1))) {
//                    return true;
//                } else if ((board[originalRow + 1][originalColumn - 1] == '.') || (blackcharecterchoosen(originalColumn - 1, originalRow + 1))) {
...
//                } else if ((board[originalRow + 1][originalColumn + 1] == '.') || (blackcharecterchoosen(originalColumn + 1, originalRow + 1))) {
//                    return true;
//                } else if ((board[originalRow][originalColumn + 1] == '.') || (blackcharecterchoosen(originalColumn + 1, originalRow))) {
//                    return true;
//                } else if ((board[originalRow][originalColumn - 1] == '.') || (blackcharecterchoosen(originalColumn - 1, originalRow))) {
//                    return true;
//                }
...
//                }
//            case 'B':
//                if ((board[originalRow - 1][originalColumn - 1] == '.') || blackcharecterchoosen(originalColumn - 1, originalRow - 1)) {
//                    return true;
//                } else if ((board[originalRow - 1][originalColumn + 1] == '.') || (blackcharecterchoosen(originalColumn + 1, originalRow - 1))) {
//                    return true;
//                } else if ((board[originalRow + 1][originalColumn - 1] == '.') || (blackcharecterchoosen(originalColumn - 1, originalRow + 1))) {
...
//                }
//            case 'N':
//                if (board[originalRow + 2][originalColumn + 1] == '.') {
//                    return true;
//                } else if (board[originalRow + 2][originalColumn - 1] == '.') {
//                    return true;
//                } else if (board[originalRow - 2][originalColumn - 1] == '.') {
//                    return true;
//                } else if (board[originalRow - 2][originalColumn + 1] == '.') {
//                    return true;
//                } else if (board[originalRow - 1][originalColumn - 2] == '.') {
//                    return true;
//                } else if (board[originalRow + 1][originalColumn - 2] == '.') {
//                    return true;
//                } else if (board[originalRow - 1][originalColumn + 2] == '.') {
...
//        init();
//
//        while (!((white_king()) || (black_king(black_k_dead)))) {
//            print_board();
//            while (white_turn) {
...
//
//
//                if ((!original_boundary(originalRow, originalColumn)) || (!blackcharecterchoosen())) {
//                    System.out.println("Invalid Original Position");
//                    continue;
//                }
//
